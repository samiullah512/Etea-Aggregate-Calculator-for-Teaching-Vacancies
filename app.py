...
def aggregate_calculator():
    ...
    ba_bsc_marks = st.number_input("Enter BA/BSc marks (leave blank if not applicable):")
    ba_bsc_total = st.number_input("Enter total BA/BSc marks (leave blank if not applicable):")
    bs_marks = st.number_input("Enter BS marks (leave blank if not applicable):")
    bs_total = st.number_input("Enter total BS marks (leave blank if not applicable):")
    ma_msc_marks = st.number_input("Enter MA/MSc marks (leave blank if not applicable):")
    ma_msc_total = st.number_input("Enter total MA/MSc marks (leave blank if not applicable):")
    ade_bed_marks = st.number_input("Enter ADE/BEd marks (leave blank if not applicable):")
    ade_bed_total = st.number_input("Enter total ADE/BEd marks (leave blank if not applicable):")
    med_marks = st.number_input("Enter MEd marks (leave blank if not applicable):")
    med_total = st.number_input("Enter total MEd marks (leave blank if not applicable):")
    mphil_marks = st.number_input("Enter MPhil marks (leave blank if not applicable):")
    mphil_total = st.number_input("Enter total MPhil marks (leave blank if not applicable):")
    phd_marks = st.number_input("Enter PhD marks (leave blank if not applicable):")
    phd_total = st.number_input("Enter total PhD marks (leave blank if not applicable):")
