...
def aggregate_calculator():
    ...
    ssc_marks = st.number_input("Enter SSC marks:", min_value=0.0)
    ssc_total = st.number_input("Enter total SSC marks:", min_value=0.0)
    hssc_marks = st.number_input("Enter HSSC marks:", min_value=0.0)
    hssc_total = st.number_input("Enter total HSSC marks:", min_value=0.0)
